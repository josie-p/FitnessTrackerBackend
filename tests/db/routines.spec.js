...
describe("DB Routines", () => {
  ...
  describe("getAllRoutines", () => {              // working!!!!!!! 3/14
  ...
  describe("getAllPublicRoutines", () => {                //working 3/14
    xit("should include the public routine", async () => {
  ...
  describe("getAllRoutinesByUser", () => {                  // working!!!! 3/14
  ...
  describe("getPublicRoutinesByUser", () => { // working!!!!! 3/14
    xit("should include the public routine", async () => {
